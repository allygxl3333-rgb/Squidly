            ...
            <section className="mt-16">
                ...
                <div className="mt-4 overflow-x-auto">
                    <table className="w-full border-separate border-spacing-0 text-[15px]">
                        <thead>
                        <tr>
                            {/* NOTE: no sticky/white overlay */}
                            <th className="text-left font-medium text-slate-600 py-3 pr-4 w-[260px]">&nbsp;</th>
                            {PLANS.map((p) => (
                        ...
                        {ROWS.map((row) => (
                            <tr key={row.feature} className="border-t border-slate-200/80">
                                <th
                                    scope="row"
                                    className="text-left font-medium text-slate-700 py-4 pr-4 w-[260px]"
                                >
                                    {row.feature}
                                </th>
